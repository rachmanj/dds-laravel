...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('suppliers/{supplier}/vendor-invoices', [\App\Http\Controllers\Admin\VendorInvoiceImportController::class, 'index'])->name('suppliers.vendor-invoices.index');
