...
@section('breadcrumb_title')
    ...
    <li class="breadcrumb-item active">With SAP Doc</li>
@endsection
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <div class="info-box">
                        ...
                        <a href="{{ route('invoices.sap-update.with-sap-page') }}"
                            class="info-box-footer bg-success text-white">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="filter-sap-doc"
                                            placeholder="SAP Doc">
                                    </div>
                                </div>
                                <div class="col-md-2">
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $('#without-sap-count').text(response.metrics.invoices_without_sap);
                },
                error: function(xhr) {
            ...
            var table = $('#with-sap-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
            ...
            $('#clear-filters').click(function() {
                $('#filter-invoice-number, #filter-po-no, #filter-sap-doc, #filter-type')
                    .val('');
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            $.ajax({
                                ...
                                type: 'GET',
                                success: function(response) {
                                    $('#without-sap-count').text(response.metrics
                                        .invoices_without_sap);
                                }
                            });
                        } else {
