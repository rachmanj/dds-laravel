                                ...
                                <div class="card card-outline card-secondary mt-3 collapsed-card"
                                    ...
                                    <div class="card-header">
                                        ...
                                        <div class="card-tools ml-auto" style="float: none;">
                                            ...
                                            <span class="badge badge-info mr-2 flex-shrink-0" id="selected-count">Selected: 0</span>
                                            <button type="button" class="btn btn-tool flex-shrink-0" data-card-widget="collapse">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                            </div>
                                        </div>
            ...
            (function invoiceDocumentImport() {
                ...
                function applyDraft(rawDraft) {
                    ...
                    try {
                        ...
                        if (draft.remarks) {
                            const cleaned = stripImportLinesFromRemarks(draft.remarks);
                            if (cleaned) {
