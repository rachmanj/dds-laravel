...
@section('title_page', 'Distributions')
@section('breadcrumb_title', 'Distributions')
                ...
                <div class="card-body">
                    @if (!auth()->user()->hasRole(['superadmin', 'admin']))
                        <div class="alert alert-info">
                            ...
                            <strong>Note:</strong> You can only see distributions that are sent to your department and are
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="search_distribution_number">Distribution Number</label>
                                                    <input type="text" class="form-control"
                                                        id="search_distribution_number" placeholder="Search by number">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="search_status">
                                                        ...
                                                        <option value="verified_by_sender">Verified by Sender</option>
                                                        <option value="sent">Sent</option>
                                                        <option value="received">Received</option>
                                                        <option value="verified_by_receiver">Verified by Receiver</option>
                                    ...
                                    @foreach ($distributions as $distribution)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <br>
                                                <small class="text-muted">{{ $distribution->document_type }}</small>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <div class="progress mt-1" style="height: 3px;">
                                                    <div class="progress-bar bg-success"
                                                        style="width: {{ $distribution->workflow_progress }}%"></div>
                                                </div>
                                            </td>
                                            <td>
                                                <span class="badge badge-secondary">{{ $distribution->documents->count() }}
                                                    docs</span>
                                            </td>
                                            <td>
                                                {{ $distribution->created_at->format('d-M-Y H:i') }}
                                                <br>
                                                <small class="text-muted">by {{ $distribution->creator->name }}</small>
                                            </td>
                                            <td>
                                                <div class="btn-group">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Are you sure you want to delete distribution <strong id="deleteDistributionNumber"></strong>?</p>
