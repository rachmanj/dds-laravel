...
## DDS integration (this repository)

When vendors expose this API to their customers, DDS can **import** those sales invoices as **local purchase invoices** for configured suppliers (`VCASJIDR01`, `VCASAIDR01`). That flow (admin UI, env vars, `cur_loc` rules, troubleshooting) is documented in **[VENDOR-INVOICE-IMPORT.md](VENDOR-INVOICE-IMPORT.md)**.
